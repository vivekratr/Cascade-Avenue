...
export default function Mainpage() {
  ...
  const handleDownload = () => {
    const pdfUrl =
      "https://cdn.discordapp.com/attachments/1096324843877703713/1172800185957621780/Cascade_Avenue_Brochure.pdf?ex=6561a249&is=654f2d49&hm=bf4a8a331f7b4cfab50a57c8d0967d0a3ff88e2caadf4434e254fdde9f84a867&";
          ...
          <div className="w-[80%] h-auto bg-white">
            ...
            <div className="flex flex-wrap lg:gap-10 mb-7  mt-3 h-[550px] lg:h-auto">
              ...
              <p className="my-2 h-fit  lg:max-w-[500px]">
                ...
                Veniam dolorem, unde asperiores itaque quae pariatur
                perspiciatis libero! Harum, non cumque. Voluptatum autem maxime
                nostrum porro expedita dolore suscipit cupiditate officiis?
                ipsum dolor sit amet consectetur adipisicing elit. Laborum ad
                minima, temporibus reiciendis ut mollitia quidem molestiae
                inventore. Aliquid deleniti nesciunt vero! Deserunt eius
  ...
  "
        ...
        {/* Partners */}
        <div id="section11" className="flex mt-[3rem] bg-white h-auto">
        ...
        >
          <div className="h-auto">
            <div className="h-[100vh] w-[63%] flex items-center justify-center mx-auto  gap-10 ">
              <div className="relative rounded-[176px] bg-white w-1/3 h-[4.69rem] overflow-hidden text-justify text-[1.35rem] text-yellow-700 font-dm-serif-display transition-transform transform hover:scale-110 cursor-pointer">
        ...
        {/* footer */}
        <div className="flex flex-col h-auto items-start mt-7 justify-center">
