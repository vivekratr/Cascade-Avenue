...
const Modal = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="fixed z-[999] inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      <div className="w-[600px] h-[400px] bg-white flex flex-col">
        <div className="relative bg-peachpuff w-[632px] max-w-[632px] h-[9.25rem] overflow-hidden text-justify text-[1.75rem] text-yellow-700 font-dm-serif-display">
        ...
        <div className="bg-white  shadow-lg p-4">Modal</div>
      </div>
    </div>
  );
};
